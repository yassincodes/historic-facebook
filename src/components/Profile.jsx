...
const profiles = {
  ibn_khaldoun: IbnKhaldoun.slice(0, 1),
  abdelaziz_thaalbi: AbdelazizThaalbi.slice(0, 1),
  barbarossa: Barbarossa.slice(0, 1),
  bourguiba: Bourguiba.slice(0, 1),
  charlesV: CharlesV.slice(0, 1),
  elissa: Elissa.slice(0, 1),
  farhat_hached: FarhatHached.slice(0, 1),
  hannibal: Hannibal.slice(0, 1),
  hayreddin_pasha: HayreddinPasha.slice(0, 1),
  jules_ferry: JulesFerry.slice(0, 1),
  khaznadar: Khaznadar.slice(0, 1),
  news5: News5.slice(0, 1),
  news6: News6.slice(0, 1),
  sinan_pasha: SinanPasha.slice(0, 1),
};

const posts = {
  ibn_khaldoun: IbnKhaldoun.slice(1),
  abdelaziz_thaalbi: AbdelazizThaalbi.slice(1),
  barbarossa: Barbarossa.slice(1),
  bourguiba: Bourguiba.slice(1),
  charlesV: CharlesV.slice(1),
  elissa: Elissa.slice(1),
  farhat_hached: FarhatHached.slice(1),
  hannibal: Hannibal.slice(1),
  hayreddin_pasha: HayreddinPasha.slice(1),
  jules_ferry: JulesFerry.slice(1),
  khaznadar: Khaznadar.slice(1),
  news5: News5.slice(1),
  news6: News6.slice(1),
  sinan_pasha: SinanPasha.slice(1),
};
